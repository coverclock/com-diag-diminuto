...
Copyright 2008-2025 by the Digital Aggregates Corporation, Colorado, USA.
...
I found valgrind not to work on my older ARM Raspbian (a.k.a. Raspberry Pi OS)
platforms, so my valgrind testing has been on Ubuntu on either x86_64
platforms, or the ARM64 version that runs on the later Raspberry Pi OS versions.
...
Diminuto user "the-real-neil" suggested some minor fixes to the Diminuto
...
Colorado and environs), at my various long time clients, who were so
