 ...
 * @brief This is a unit test of the Number feature.
 * @author Chip Overclock <mailto:coverclock@diag.com>
 * @see Diminuto <https://github.com/coverclock/com-diag-diminuto>
 * @details
 * This is a unit test of the Number feature.
 */
...
int main(int argc, char ** argv)
{
    ...
    while ((argc--) > 0) {
        ...
        CHECKPOINT("0%llo 0x%llx %llu %lld 0x%x\n", (long long unsigned int)n, (long long unsigned int)n, (long long unsigned int)n, (diminuto_lld_t)n, *p);
    }
