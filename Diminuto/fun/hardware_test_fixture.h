...
#define COM_DIAG_DIMINUTO_HARDWARE_TEST_FIXTURE_GPIO_DEVICE_PI4 "/dev/gpiochip0"

#define COM_DIAG_DIMINUTO_HARDWARE_TEST_FIXTURE_GPIO_DEVICE_PI5 "/dev/gpiochip4"
