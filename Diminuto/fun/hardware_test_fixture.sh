...
PI4_HARDWARE_TEST_FIXTURE_DEVICE="/dev/gpiochip0"
PI5_HARDWARE_TEST_FIXTURE_DEVICE="/dev/gpiochip4"

if [ -c ${PI4_HARDWARE_TEST_FIXTURE_DEVICE} ]; then
	HARDWARE_TEST_FIXTURE_DEVICE=${PI4_HARDWARE_TEST_FIXTURE_DEVICE}
elif [ -c ${PI5_HARDWARE_TEST_FIXTURE_DEVICE} ]; then
	HARDWARE_TEST_FIXTURE_DEVICE=${PI5_HARDWARE_TEST_FIXTURE_DEVICE}
else
	exit 1
fi
