...
typedef enum DiminutoPolicyScheduler {
     ...
     * DEFAULTS
     */
    DIMINUTO_POLICY_SCHEDULER_DEFAULT           = SCHED_OTHER,
    DIMINUTO_POLICY_SCHEDULER_THREAD            = SCHED_RR,
    DIMINUTO_POLICY_SCHEDULER_TIMER             = SCHED_FIFO,
...
typedef enum DiminutoPolicyPriority {
     ...
     * DEFAULTS
     */
    DIMINUTO_POLICY_PRIORITY_DEFAULT            = 0,
