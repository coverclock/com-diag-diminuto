...
typedef enum DiminutoMemoryPagesizeMethod {
    DIMINUTO_MEMORY_PAGESIZE_METHOD_IMPLICIT            = 'I',
    DIMINUTO_MEMORY_PAGESIZE_METHOD_EXPLICIT            = 'E',
    DIMINUTO_MEMORY_PAGESIZE_METHOD_SYSCONF_PAGESIZE    = 'C',
    DIMINUTO_MEMORY_PAGESIZE_METHOD_GETPAGESIZE         = 'G',
    DIMINUTO_MEMORY_PAGESIZE_METHOD_UNKNOWN             = '?',
...
typedef enum DiminutoMemoryLinesizeMethod {
    DIMINUTO_MEMORY_LINESIZE_METHOD_IMPLICIT                        = 'i',
    DIMINUTO_MEMORY_LINESIZE_METHOD_EXPLICIT                        = 'e',
    DIMINUTO_MEMORY_LINESIZE_METHOD_SYSCONF_LEVEL1_DCACHE_LINESIZE  = 'c',
    DIMINUTO_MEMORY_LINESIZE_METHOD_SYS_INDEX0_COHERENCY_LINE_SIZE  = 'n',
    DIMINUTO_MEMORY_LINESIZE_METHOD_SYS_COHERENCY_LINE_SIZE         = 'l',
    DIMINUTO_MEMORY_LINESIZE_METHOD_UNKNOWN                         = '?',
