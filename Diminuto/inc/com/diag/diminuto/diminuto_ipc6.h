 ...
 */
extern char * diminuto_ipc6_colonnotation(diminuto_ipv6_t address, void * buffer, size_t length);
 ...
 * @return a pointer to the buffer.
 */
static inline char * diminuto_ipc6_address2string(diminuto_ipv6_t address, void * buffer, size_t length) {
