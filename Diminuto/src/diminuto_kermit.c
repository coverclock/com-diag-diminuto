 ...
 * @brief This is the implementation of the Kermit feature.
 * @author Chip Overclock <mailto:coverclock@diag.com>
 * @see Diminuto <https://github.com/coverclock/com-diag-diminuto>
 * @details
 * This is the implementation of the Kermit feature.
 */
...
{
    uint8_t * here = (uint8_t *)buffer;

    while (length--) {
        crc = (crc >> 8) ^ TABLE[(crc ^ (*(here++))) & 0xff];
    }
