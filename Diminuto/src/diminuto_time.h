 ...
 */
extern diminuto_sticks_t diminuto_time_clock_log(void);
 ...
 */
extern int diminuto_time_zulu_log(diminuto_sticks_t ticks, int * yearp, int * monthp, int * dayp, int * hourp, int * minutep, int * secondp, diminuto_ticks_t * tickp);
